...
class WidgetFactory:
    ...
    def create_paned_window(self, parent, **kwargs):
        """创建标准分割窗口"""
        paned_window_style = BaseElement.panedWindow
    ...
    def create_scrolled_window(self, parent, **kwargs):
        """创建带滚动条的框架"""
        scrolled_window_style = BaseElement.scrolledWindow
    ...
    def create_button(self, parent, text, command=None, **kwargs):
        """创建标准按钮"""
        button_style = BaseElement.button
    ...
    def create_checkbutton(self, parent, text, variable, command=None, **kwargs):
        """创建标准复选框"""
        checkbutton_style = BaseElement.checkbutton
