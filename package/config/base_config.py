class BaseConfig:
    ...
    PUBCHEM_PROPERTY_BATCH_SIZE = 100
    PUBCHEM_PROPERTY_BATCH_RETRIES = 2
    PUBCHEM_PROPERTY_MIN_CHUNK_SIZE = 10
    PUBCHEM_INCREMENTAL_CACHE_ENABLED = True
    PUBCHEM_ALLOW_PARTIAL_RESULTS = True